  ...
  return (
    <div className="h-screen w-screen overflow-hidden bg-[#070912] text-slate-300 font-sans relative flex flex-col">
      ...
      <div className="relative z-10 flex-1 overflow-hidden p-6 lg:p-8 flex flex-col">
        ...
        {/* ===================== TAB 2: SYSTEM & DEV ===================== */}
        {activeTab === 'system' && (
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 h-full min-h-0 animate-[fadeScaleIn_0.3s_ease-out_forwards] content-start overflow-y-auto pb-10 p-6 lg:p-8 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:'none'] [scrollbar-width:'none']">
